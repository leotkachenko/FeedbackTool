...
RightResponseComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: RightResponseComponent, selectors: [["app-right-response"]], decls: 3, vars: 0, consts: [[1, "text-center"], [1, "display-3"]], template: function RightResponseComponent_Template(rf, ctx) { if (rf & 1) {
...
UploadFileComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵdefineComponent"]({ type: UploadFileComponent, selectors: [["app-upload-file"]], decls: 20, vars: 8, consts: [["class", "progress", 4, "ngIf"], [1, "btn", "btn-default"], ["type", "file", 3, "change"], [1, "btn", "btn-primary", 3, "disabled", "click"], ["role", "alert", 1, "alert", "alert-light"], [1, "card"], [1, "card-header"], ["class", "list-group list-group-flush", 4, "ngFor", "ngForOf"], [3, "formGroup", "ngSubmit"], [1, "form-group"], ["for", "tittle"], ["formControlName", "tittle", "name", "tittle", 1, "form-control"], ["type", "submit", 1, "btn", "btn-primary", 3, "disabled"], [1, "progress"], ["role", "progressbar", "aria-valuemin", "0", "aria-valuemax", "100", 1, "progress-bar", "progress-bar-info", "progress-bar-striped", 3, "ngStyle"], [1, "list-group", "list-group-flush"], [1, "list-group-item"], [3, "href"]], template: function UploadFileComponent_Template(rf, ctx) { if (rf & 1) {
        ...
        _angular_core__WEBPACK_IMPORTED_MODULE_2__["ɵɵlistener"]("ngSubmit", function UploadFileComponent_Template_form_ngSubmit_13_listener() { return ctx.onSubmit(ctx.FormData.value); });
...
class FeedbackService {
    ...
    PostMessage(input) {
        const myHeaders = new _angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpHeaders"]().set('Access-Control-Allow-Origin', '*').set('Access-Control-Allow-Methods', 'GET, POST, OPTIONS, PUT, PATCH, DELETE')
...
FeedbackService.ɵfac = function FeedbackService_Factory(t) { return new (t || FeedbackService)(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵinject"](_angular_common_http__WEBPACK_IMPORTED_MODULE_0__["HttpClient"])); };
